...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeamBox = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(TeamBox, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TeamSelector = __webpack_require__(160);
	var TeamDetail = __webpack_require__(161);
	...
	var TeamBox = React.createClass({
	  ...
	  setFocusTeam: function setFocusTeam(index) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(TeamDetail, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeamSelector = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "select",
	      { id: "teams", onChange: this.handleChange },
	      React.createElement(
	        "option",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var PlayerBox = __webpack_require__(162);
	var FixtureBox = __webpack_require__(165);
	
	var TeamDetail = function TeamDetail(props) {
	  if (!props.team) {
	    return React.createElement(
	      "h3",
	      null,
	  ...
	  return React.createElement(
	    ...
	    React.createElement("img", { src: props.team.crestUrl, width: "100" }),
	    React.createElement(
	      "ul",
	      null,
	      React.createElement(
	        ...
	        null,
	        "Squad market value: ",
	        props.team.squadMarketValue
	      )
	    ),
	    React.createElement(PlayerBox, { url: props.team['_links'].players.href }),
	    React.createElement(FixtureBox, { url: props.team['_links'].fixtures.href })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerSelector = __webpack_require__(163);
	var PlayerDetail = __webpack_require__(164);
	...
	var PlayerBox = React.createClass({
	  ...
	  setFocusPlayer: function setFocusPlayer(index) {
	    this.setState({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(PlayerDetail, { player: this.state.focusPlayer })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerSelector = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "select",
	      { id: "players", onChange: this.handleChange },
	      React.createElement(
	        "option",
	        { selected: true, disabled: true },
	        "Choose a player..."
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerDetail = function PlayerDetail(props) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var FixtureList = __webpack_require__(166);
	
	var FixtureBox = React.createClass({
	  displayName: 'FixtureBox',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Fixture = __webpack_require__(167);
	
	var FixtureList = function FixtureList(props) {
	  ...
	  try {
	    for (var _iterator = props.fixtures[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	  ...
	  var fixtureNodes = fixtures.map(function (fixture, index) {
	    return React.createElement(
	      'li',
	      { key: index },
	      React.createElement(Fixture, { fixture: fixture })
	    );
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fixture = function Fixture(props) {
